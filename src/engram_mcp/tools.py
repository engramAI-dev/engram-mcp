...
`engram_mcp.server._dispatch`. The `Dispatcher` Protocol is what the
HTTP-backed `EngramClient` (and any future in-process implementations)
must satisfy.
"""
...
class Dispatcher(Protocol):
    """What `build_server` requires from any backend implementation."""
